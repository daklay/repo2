...
const EmptyPage = () => {
  const Service = ["Creation", "Comptabilite", "Bibliotheque"];
  ...
  const [RappelStaf, setRappelStaf] = useState([]);
    ...
    <>
      <div className="grid">
        <div className="col-12">
          <Fieldset legend="Formulaire de Rappel Staff" toggleable>
            <form>
              <div className="p-fluid formgrid grid">
                ...
                {DataFormAjouter.service === "Creation" ? (
                  <div className="field col-4">
      ...
      >
        <Fieldset legend="Formulaire de Update Rappel Staff">
          <form>
            <div className="p-fluid formgrid grid">
              <div
                className={
                  DataFormUpdate.service === "Creation"
                    ? "field col-6"
                    : "field col-6"
                }
              >
